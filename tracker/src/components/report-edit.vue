<template>
  <div class="report">
    ...
    <div class="container-fluid pt-5">
      <h2>
        Post-Event Report
        <span v-if="event.name">for {{ event.name }}</span>
      </h2>
      ...
      <b-row>
        <b-col cols="6" offset="3">
          ...
          <b-form-group
            horizontal
            id="overview"
            label="General Impression (would you go back next year?)"
            label-for="overview"
            v-if="this.$route.params.type != 'other'"
          >
          ...
          <b-form-group
            horizontal
            id="notes"
            label="Other Notes (followups to do, people you met, ...)"
            label-for="notes"
          >
