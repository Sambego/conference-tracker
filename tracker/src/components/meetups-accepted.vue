  ...
  <div class="meetups-accepted">
    ...
    <b-row>
      <b-col cols="6" offset="3">
        <b-form-group id="talk" label="Which talk got accepted?" label-for="talk">
          <b-form-select id="talk" :options="talkOptions" required v-model="meetup.talkId"></b-form-select>
        </b-form-group>
...
export default {
  ...
  methods: {
    ...
    saveAcceptance() {
      ...
      confirmMeetup(this.$route.params.meetupId, formattedMeetup).then(() =>
